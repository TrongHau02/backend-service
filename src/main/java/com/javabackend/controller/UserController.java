...
public class UserController {
    ...
    public void confirmEmail(@RequestParam String secrectCode, HttpServletResponse response) throws IOException {
        log.info("Confirm email:  {}", secrectCode);
        try {
            //TODO check or compare secrect code from database
        } catch (Exception exception) {
            log.error("Error occurred while trying to confirm email, error: {}", exception.getMessage());
        } finally {
